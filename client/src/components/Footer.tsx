    ...
    <footer className="bg-space-black bg-opacity-80 border-t border-gray-800 py-8">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col md:flex-row justify-between items-center">
          ...
          <div className="mb-6 md:mb-0 md:mx-4 text-center md:text-left">
            <h3 className="text-white font-semibold mb-3 text-base">Developed By</h3>
            <div className="flex flex-col space-y-1">
              <p className="text-white font-medium text-sm">Tin Le</p>
              <div className="flex flex-wrap justify-center md:justify-start gap-3 mt-2">
                <a href="https://tinle.xyz/" target="_blank" rel="noopener noreferrer" 
                   className="text-xs bg-gray-800 text-white px-3 py-1 rounded-full hover:bg-primary transition-colors">
                  Portfolio
                </a>
                <a href="https://www.linkedin.com/in/tintrungle/" target="_blank" rel="noopener noreferrer" 
                   className="text-xs bg-gray-800 text-white px-3 py-1 rounded-full hover:bg-blue-700 transition-colors">
                  LinkedIn
                </a>
                ...
                <a href="https://github.com/NedWithNoHead/SpaceExplorer" target="_blank" rel="noopener noreferrer" 
                   className="text-xs bg-gray-800 text-white px-3 py-1 rounded-full hover:bg-green-700 transition-colors">
                  Project Repo
                </a>
              </div>
            </div>
