  ...
  return (
    <Card className="lg:col-span-7 bg-gray-900 bg-opacity-50 rounded-xl p-6 border border-gray-800 h-96 flex items-center justify-center relative overflow-hidden">
      ...
      <div className="relative w-full h-full">
        ...
        {/* Moon orbit */}
        <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-[200px] h-[200px] rounded-full border border-gray-500 border-dashed opacity-20"></div>
        ...
        {visibleAsteroids.map((asteroid, index) => {
          // Calculate orbit size - more compact to ensure all are in frame
          const orbitSize = 40 + (index * 15); 
