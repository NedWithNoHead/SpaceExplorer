...
export default function AsteroidsPage() {
  ...
  // Get current date and date a week from now
  ...
  return (
    <>
      <Helmet>
        <title>Near-Earth Asteroid Tracker - Space Explorer</title>
        <meta name="description" content="Monitor near-Earth asteroids and their close approaches to our planet. Interactive visualization and detailed data on asteroid sizes, velocities, and miss distances." />
        <meta property="og:title" content="Asteroid Tracker - Space Explorer" />
        <meta property="og:description" content="Track near-Earth objects and their orbital paths with our interactive asteroid visualization tool." />
      ...
      <div className="relative flex flex-col min-h-screen overflow-hidden bg-space-black">
        ...
        <main className="flex-grow">
          <section id="asteroids" className="py-16">
